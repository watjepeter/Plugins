...
#define MAXVER_INTERNALNAME "lattice\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "lattice.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Mesh to lattice modifier (plugin)\0"//should  be overidden on a per-dll level
